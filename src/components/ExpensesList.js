...
export const ExpensesList = ({
  ...
  return (
    <tr
      key={i}
      className='h-24 border-gray-300 dark:border-gray-200 border-b cursor-pointer'
    >
      <td
      ...
      <td
        ...
        onClick={() => deleteExpens(id, idDetail)}
      >
        <svg
