              ...
              <ul className='pr-12 xl:flex items-center h-full hidden'>
                <Link
                  ...
                  className={`cursor-pointer h-full flex items-center hover:text-indigo-700 text-sm text-white tracking-normal ${
                    activeItem === 0 ? 'border-b-2 border-white' : ''
                  }`}
                ...
                <Link
                  to='/map'
                  className={`cursor-pointer h-full flex items-center hover:text-indigo-700 text-sm text-white mx-10 tracking-normal ${
                    activeItem === 1 ? 'border-b-2 border-white' : ''
                  }`}
                  onClick={() => handleItemClick(1)}
                >
                  <li>Miejsca w okolicy</li>
                </Link>
                <Link
                  to='/expenses'
                  className={`cursor-pointer h-full flex items-center hover:text-indigo-700 text-sm text-white mr-10 tracking-normal ${
                    activeItem === 2 ? 'border-b-2 border-white' : ''
                  }`}
                ...
                {user !== null ? (
                  <>
                    ...
                    <div className='w-full h-full flex'>
                      ...
                      <div
                        className='w-full flex items-center justify-end relative cursor-pointer z-[100]'
                        ...
                        {profile && (
                          <ul className='p-2 w-40 border-r bg-white absolute rounded left-0 shadow mt-16 top-0 '>
                            ...
                            <li className='cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none'>
                              ...
                              <span className='ml-2'>Ustawienia konta</span>
                            </li>
                            <li
                              onClick={signUserOut}
                  ...
                  <>
                    ...
                    <div className='w-full h-full flex'>
                      ...
                      <div className='w-full flex items-center justify-end relative cursor-pointer'>
                        <Link to={'/login'}>
                          <p className='text-white text-sm ml-2'>Zaloguj się</p>
                        </Link>
                      </div>
                    </div>
                  </>
